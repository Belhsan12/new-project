...
function HomePage() {
  ...
  return (
    <div className="space-y-12">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-primary-DEFAULT to-primary-light dark:from-darkBg-darker dark:to-darkBg-DEFAULT text-primary-contrast py-20 px-6 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {categories.map(category => (
            <Link
              ...
              className="block bg-white dark:bg-darkBg-card rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden text-center py-8 px-4 group"
            >
